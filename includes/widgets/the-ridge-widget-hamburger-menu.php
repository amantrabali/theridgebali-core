	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'label' => esc_html__( 'Main Menu Width', 'theridgebali-core' ),
				'range' => [
					'px' => [
						'min' => 0,
						'max' => 100,
		...
		$this->add_responsive_control(
			'hamburger_close_menu',
			[
				'type' => \Elementor\Controls_Manager::SLIDER,
				'label' => esc_html__( 'Close Menu Width', 'theridgebali-core' ),
				'range' => [
					'px' => [
						'min' => 0,
						'max' => 100,
				...
				'selectors' => [
					'{{WRAPPER}} .hamburger-close-menu' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
        ...
        <div class="col-md-3 col-xs-3">
              <div class="nav-trigger">
	                <svg class="hamburger-main-menu" width="100%" height="100%" viewBox="0 0 50 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <aside id="navigation">
		    <div class="inner">
		        <div class="nav-trigger">
		            <svg class="hamburger-close-menu" width="100%" height="100%" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
