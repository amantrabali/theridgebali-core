	...
	protected function render() {
		...
		<div class="col-md-8 px-0">
			...
			<?php foreach ( $categoryalls as $categoryall) { ?>
				<?php  $class = $categoryall->term_id == $current_category ? 'class="blog-category current-category"' : 'class="blog-category"'; ?>
				<div class="col-lg-2 col-md-2 col-xs-2 mb-3 d-flex align-items-stretch">
	    	...
	    	<?php
			    ...
			    if ($query->have_posts()) {
			    	while ($query->have_posts()) {
		    			...
		    			<div class="col-lg-4 col-md-12 mb-3 d-flex align-items-stretch px-0">
